...
<html>
    <head>
        ...
        <title>遷移ページ | 第78回水戸一高・附属中学校学苑祭「天翔る」</title>
        <meta name="description" content="リーフレットからの遷移ページです。">
        ...
        <!-- CSS -->
        <link rel="stylesheet" type="text/css" href="<?php echo $base_path; ?>/assets/css/transition_universal.css">
        ...
        <link rel="icon" type="image/png" href="<?php echo $base_path; ?>/materials/favicon/android-chrome-192x192.png">
        ...
        <meta name="apple-mobile-web-app-title" content="セットリスト / タイムテーブル 遷移ページ">
    </head>
    <body>
        <!-- Main -->
         <main class="transition_main">
            <div class="transition_container">
                <div class="transition_ellipse"></div>
                <div class="transition_content">
                    <!-- Description -->
                    <p class="transition_text">
                        リーフレットからの遷移ページです。
                        <br>下記のリンクからご希望のページをご覧ください。
                    </p>
                    <div class="transition_divider_center"></div>
                    <!-- Link Tree -->
                    <a href="https://gakuensai.net/pages/setlist.php" class="link_box">
                        <img src="" class="link_image">
                        <p class="link_box_text">セットリスト</p>
                    </a>

                    <a href="https://gakuensai.net/pages/timetable.php" class="link_box">
                        <img src="" class="link_image">
                        <p class="link_box_text">タイムテーブル</p>
                    </a>
                </div>
            </div>
         </main>
