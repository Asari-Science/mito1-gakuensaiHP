...
<style>
    ...
    <head>
        ...
        <title>503 - 気流乱れ | 第78回水戸一高・附属中学校学苑祭「天翔る」</title>
    ...
    <body>
        ...
        <!-- Main -->
         <main class="error_main">
            <div class="error_container error_503">
                <!-- Sky Background -->
                ...
                <div class="error_content">
                    <p class="error_code">Turbulence Detected</p>
                    <p class="error_altitude">503</p>
                    <p class="error_altitude_unit">- TURBULENCE -</p>

                    <h1 class="error_title">創造の熱気で<br>気流が乱れています</h1>

                    <p class="error_message">
                        たくさんの搭乗者が一度に押し寄せ、<br>
                        上昇気流が激しく渦巻いています。<br>
                        少し時間を置いてから、再度テイクオフしてください。
                    </p>
