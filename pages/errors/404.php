...
<style>
    ...
    <head>
        ...
        <title>404 - 高度404m | 第78回水戸一高・附属中学校学苑祭「天翔る」</title>
    ...
    <body>
        ...
        <!-- Main -->
         <main class="error_main">
            <div class="error_container error_404">
                <!-- Sky Background -->
                ...
                <div class="error_content">
                    <p class="error_code">Altitude Warning</p>
                    <p class="error_altitude">404</p>
                    <p class="error_altitude_unit">- ALTITUDE (m) -</p>

                    <h1 class="error_title">高度を上げすぎた<br>ようです</h1>

                    <p class="error_message">
                        おっと、雲を突き抜けてしまいました。<br>
                        お探しの景色（ページ）は、<br>
                        この高度では見つかりません。
                    </p>
