...
<html lang="ja">
    <head>
        ...
        <title>Coming Soon | 第78回水戸一高・附属中学校学苑祭「天翔る」</title>
        <meta name="description" content="このページは現在準備中です。第78回学苑祭の公式サイト。">
        ...
        <!-- Main -->
         <main class="comingsoon_main">
            <div class="comingsoon_container">
                <div class="comingsoon_ellipse"></div>
                <div class="comingsoon_content">
                    <p class="comingsoon_label">Coming Soon</p>
                    <h1 class="comingsoon_title">準備中</h1>
                    <p class="comingsoon_message">
                        このページは現在制作中です。<br>
                        公開までもうしばらくお待ちください。
                    </p>
