    ...
    <div class="footer_container" style="background-color: <?php echo $footer_bg_color ?? "#dab584"?>;">
        <div class="footer_frame">
            ...
            <div class="footer_sns_section">
                <span class="footer_sns_label">公式SNS</span>
                <div class="footer_sns_icons">
                    <a href="https://x.com/Enjitsu78th" class="footer_sns_link" aria-label="X (Twitter)">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    <a href="https://www.instagram.com/enjitsu78th" class="footer_sns_link" aria-label="Instagram">
                    ...
                    <a href="#" class="footer_sns_link" aria-label="LINE">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 10.304c0-5.231-5.383-9.486-12-9.486s-12 4.255-12 9.486c0 4.69 4.27 8.607 10.038 9.352.391.084.924.258 1.058.594.121.303.079.778.038 1.083l-.164 1.025c-.049.303-.238 1.187 1.026.647 1.264-.54 6.819-4.017 9.302-6.878 1.706-1.859 2.641-3.69 2.641-5.823zm-15.004 3.39h-2.155v-4.597h.653v3.944h1.502v.653zm3.172 0h-.653v-4.597h.653v4.597zm3.149 0h-.653l-1.636-2.45v2.45h-.653v-4.597h.653l1.636 2.452v-2.452h.653v4.597zm3.018-3.944h-1.502v1.31h1.502v.653h-1.502v1.328h1.502v.653h-2.155v-4.597h2.155v.653z"/></svg>
                    </a>
                </div>
            </div>
            ...
            <!-- Hashtag -->
            <a href="https://twitter.com/intent/tweet?url=https://gakuensai.net/&hashtags=水高の最もアツい日,文化祭,天翔る,第78回学苑祭" class="hashtug">
                <p>#水高の最もアツい日　#水戸一高　#文化祭　#天翔る　#第78回学苑祭</p>
            </a>
            ...
            <a href="<?php echo $base_path; ?>/pages/comingsoon.php" class="footer_tea_btn" aria-label="お茶を入れる" title="お茶を入れる">&#x2615;</a>
        </div>
    </div>
</footer>
